...
public class Second extends HttpServlet {
	...
	protected void service(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		session.setAttribute("dno", request.getParameter("dno"));
...
protected void doGet(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
	resp.getWriter().print("<!DOCTYPE html>\n"
			...
			+ "	<form action=\"View\" name=\"form\" method=\"post\">\n"
			+ "		<label>Enter Permanent Address : </label> &nbsp;<input type=\"text\" name=\"pa\" ><br><!-- pattern=\"[A-Za-z]+\" -->\n"
			+ "		<br> <label>Enter Temporary Address :</label> &nbsp;&nbsp;&nbsp;<input\n"
			+ "			type=\"text\" name=\"ta\" ><br> <br> \n"
			+ "			<label>Married :</label> &nbsp;&nbsp;&nbsp;<input\n"
			+ "			type=\"text\" name=\"married\" ><br> <br>\n"
