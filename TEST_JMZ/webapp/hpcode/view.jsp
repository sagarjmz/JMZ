...
<div></div>
	<form name="myForm" id="myForm" action="./../Store" method="POST" >
		...
		<input type="text" id="f" class="button" name="examId" value="${examId}"/>
		<input type="text" id="f" class="button" name="email" value="${email}"/>
		<input type="text" id="f" class="button" name="userId" value="${id}"/>
