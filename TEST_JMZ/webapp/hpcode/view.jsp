...
<div></div>
	<form name="myForm" id="myForm" action="./../Store" method="POST" >
		...
		<input type="text" id="f" class="button" name="email" value="${sessionScope.email}"/>
		<input type="hidden" id="f" class="button" name="date" value="${sessionScope.date}"/><!-- //******* -->
	...
	(function() {
		...
		function displayResult() {
			...
			if (correct >= 3) {
				...
				score.append('<a style=font-color:white href="entrance.jsp">Exam Schedule </a>' + ' '
						+ 'examination pass ' + 'correct answer : ' + correct);
				return score;
			} else {
				score.append('<a href="entrance.jsp">Exam Schedule </a>' + ' '
						+ 'examination fail ' + 'correct answer : ' + correct);
				return score;
			}
